...
class QRPay {
    ...
    build() {
        ...
        if (this.provider.guid === qr_pay_1.QRProviderGUID.VIETQR) {
            ...
            providerDataContent = (_d = this.provider.data) !== null && _d !== void 0 ? _d : '';
        }
        ...
        const currency = QRPay.genFieldData(qr_pay_1.FieldID.CURRENCY, (_e = this.currency) !== null && _e !== void 0 ? _e : '704');
        ...
        const nation = QRPay.genFieldData(qr_pay_1.FieldID.NATION, (_f = this.nation) !== null && _f !== void 0 ? _f : 'VN');
        ...
        const EVMCoContent = Object.keys((_g = this.EVMCo) !== null && _g !== void 0 ? _g : {}).sort().map(key => { var _a; return QRPay.genFieldData(key, (_a = this.EVMCo) === null || _a === void 0 ? void 0 : _a[key]); }).join('');
        const unreservedContent = Object.keys((_h = this.unreserved) !== null && _h !== void 0 ? _h : {}).sort().map(key => { var _a; return QRPay.genFieldData(key, (_a = this.unreserved) === null || _a === void 0 ? void 0 : _a[key]); }).join('');
    ...
    parseAdditionalData(content) {
        ...
        switch (id) {
            ...
            case qr_pay_1.AdditionalDataID.PURPOSE_OF_TRANSACTION:
                ...
                break;
            case qr_pay_1.AdditionalDataID.ADDITIONAL_CONSUMER_DATA_REQUEST:
